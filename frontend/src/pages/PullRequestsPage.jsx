  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-xs text-gray-400 mt-1">Review automated AI security scans on incoming code changes</p>
      </div>
      ...
      <div className="glass-card-linear rounded-2xl border border-white/10 p-12 text-center bg-[#0a0f1d]/80 max-w-xl mx-auto my-8 relative overflow-hidden shadow-2xl">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Automated PR Analysis Coming Soon</h2>
        <p className="text-xs text-gray-400 max-w-md mx-auto mb-6 leading-relaxed">
          Deep AST code diff auditing, inline PR security comments, and automated fix suggestions will be available shortly.
        </p>
        <Link
          to="/dashboard"
