  ...
  return (
    <div className="space-y-6">
      ...
      <nav className="flex items-center gap-2 text-xs text-gray-400">
        ...
        <span className="text-gray-200 font-medium">Analytics</span>
      </nav>

      {/* Page Header */}
      <div>
        <h1 className="text-2xl font-bold text-white tracking-tight">Security Analytics & Insights</h1>
        <p className="text-xs text-gray-400 mt-1">Metrics, vulnerability trends, and engineering velocity analytics</p>
      </div>
      ...
      <div className="glass-card-linear rounded-2xl border border-white/10 p-12 text-center bg-[#0a0f1d]/80 max-w-xl mx-auto my-8 relative overflow-hidden shadow-2xl">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Advanced Analytics Dashboard Coming Soon</h2>
        <p className="text-xs text-gray-400 max-w-md mx-auto mb-6 leading-relaxed">
          Security score trends, vulnerability resolution SLAs, and team code quality benchmarks will be available in the next release.
        </p>
        <Link
          to="/dashboard"
