...
export const NotificationsPage = () => {
  return (
    <div className="space-y-6">
      ...
      {/* Page Header */}
      <div>
        <h1 className="text-2xl font-bold text-white tracking-tight">Security Notifications & Alerts</h1>
        <p className="text-xs text-gray-400 mt-1">Real-time alerts, Slack integrations, and webhook logs</p>
      </div>
      ...
      <div className="glass-card-linear rounded-2xl border border-white/10 p-12 text-center bg-[#0a0f1d]/80 max-w-xl mx-auto my-8 relative overflow-hidden shadow-2xl">
        ...
        <h2 className="text-xl font-bold text-white mb-2">Notification Center Coming Soon</h2>
        <p className="text-xs text-gray-400 max-w-md mx-auto mb-6 leading-relaxed">
          Custom alert threshold routing, Slack and Discord webhook integrations, and email digest preferences are being configured.
        </p>
        <Link
          to="/dashboard"
